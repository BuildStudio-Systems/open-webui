...
<div class="px-1 mb-1 flex justify-center space-x-2 relative z-10" id="search-container">
	...
	{#if focused && (filteredOptions.length > 0 || filteredItems.length > 0)}
		...
		<div
			class="buildstudio-listbox absolute top-0 mt-8 left-0 right-1 border border-gray-100 dark:border-gray-900 bg-gray-50 dark:bg-gray-950 rounded-2xl z-10 shadow-lg"
