...
{#if suggestionsOpen && optionVoices.length > 0}
	<div
		...
		id={listboxId}
		class="buildstudio-listbox fixed max-h-48 overflow-y-auto rounded-2xl border border-gray-200 bg-white p-0.5 shadow-lg dark:border-gray-800 dark:bg-gray-850"
		role="listbox"
