...
{#if variant === 'dropdown'}
	...
	>
		...
		<div slot="content">
			<div
				class="buildstudio-dropdown-menu z-[10000] flex w-96 max-w-[calc(100vw-2rem)] flex-col rounded-xl border border-gray-200 bg-white p-0.5 text-black shadow-lg dark:border-gray-800 dark:bg-gray-850 dark:text-white"
			>
